...
import { FiltroAporte } from 'src/app/_services/aporte.service';
import { Auxiliar } from 'src/app/_helpers/auxiliar';
import { NavParams, ModalController } from '@ionic/angular';
import * as moment from 'moment';

@Component({
  selector: 'app-filtro-aporte-modal',
  templateUrl: './filtro-aporte-modal.component.html',
  styleUrls: ['./filtro-aporte-modal.component.scss'],
})
export class FiltroAporteModalComponent implements OnInit {

  fecha_desde = null;
  fecha_hasta = null;

  monthNames:string[]=Auxiliar.dateTimeMonthNames;
  private filtro:FiltroAporte;
  hoy:string;
  constructor(
